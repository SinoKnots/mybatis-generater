package com.sinoknots.generator;
...
public class MyLombokPlugin extends PluginAdapter {
	...
	public boolean validate(List<String> warnings) {
		...
		try {
			...
			warnings.add(Messages.getString("ValidationError.18", "MyLombokPlugin", "MY_SUPPER_CLASS"));
			valid = false;
		}
...
//		topLevelClass.addAnnotation("@EqualsAndHashCode(callSuper = false)");
		...
		topLevelClass.addJavaDocLine("* ");
		topLevelClass.addJavaDocLine("* @author sinoknots ");
		topLevelClass.addJavaDocLine("* @version V1.0.0");
		topLevelClass.addJavaDocLine("* @since V1.0.0(" + date2Str(new Date()) + ")");
		topLevelClass.addJavaDocLine("*/");
	...
	public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass,
		...
		interfaze.addJavaDocLine("* ");
		interfaze.addJavaDocLine("* @author sinoknots ");
		interfaze.addJavaDocLine("* @version V1.0.0");
		interfaze.addJavaDocLine("* @since V1.0.0(" + date2Str(new Date()) + ")");
		interfaze.addJavaDocLine("*/");
		return true;
	}
